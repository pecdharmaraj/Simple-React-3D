...
Command: npx gltfjsx@6.2.3 webdevelopment.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/webdevelopment-transformed.glb')
  return (
...
useGLTF.preload('/webdevelopment-transformed.glb')
